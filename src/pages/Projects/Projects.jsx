...
const BlogsData = [
  ...
  },
  {
    ...
    image3: MImg3,
    image4: MImg4,
    title: "KUSS - Movie ticket booking app",
    description:
      "The application aims to simplify the movie ticket booking process, enhance the overall movie-going experience, and offer a centralized place for all things related to movie ticket reservations. Developed using C#, .NET, and SQL Server Management, this robust platform provides users with an intuitive interface for booking seats and viewing movie details. Users can effortlessly browse through the latest movie listings, select their preferred showtimes, and choose from available seats, ensuring a hassle-free booking experience. The application also features detailed movie descriptions, trailers, and ratings, helping users make informed decisions about their movie choices.In addition to booking seats and viewing movie details, the platform allows users to manage their bookings, view their booking history, and receive notifications about upcoming releases and special offers. The integration of SQL Server Management ensures that all user data and booking information is securely stored and efficiently managed. Administrators can easily update movie listings, manage seat availability, and generate reports on booking trends. The application also supports secure payment processing, providing users with a safe and reliable way to complete their transactions. By streamlining the movie ticket reservation process and enhancing the overall user experience, this application transforms how movie enthusiasts plan their cinema outings.",
    author: "Someone",
    date: "April 22, 2022",
    link:"https://waveai.netlify.app/",
  },
