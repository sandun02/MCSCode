      ...
      <div className=" dark:text-white group">
        <div className="overflow-hidden">
          <img
            src={image}
            alt="No image"
            className="mx-auto h-[420px] w-full object-fill group-hover:scale-105 duration-300 rounded-3xl"
          />
        ...
        <div className="space-y-2 p-4 ml-6 bg-white dark:bg-slate-950 -translate-y-16">
          ...
          <p className="line-clamp-4 text-gray-500 text-sm text-justify">{description}</p>
